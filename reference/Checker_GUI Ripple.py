...
class PopUp(QWidget):
    def __init__(self, parent=None):
        ...
        self.buton = QPushButton(' {} '.format(msg))
        ...
        self.move(int(x - ( self.width() / 2.3 )) + 223, int(y + ( self.height() / 2 )) - 223)
        self.show()
...
class MainWindow(QWidget):
    ...
    def Tab1ButtonClick(self):
        ...
        if (len(self.Tab1input1.text()) != 2 and len(self.Tab1input1.text()) != 3):
            if (len(self.Tab1name1) != 2 and len(self.Tab1name1) != 3):
                self.ballon11 = self.PopUpReady(self.Tab1input1, 'Invalid Value')

        if (len(self.Tab1input2.text()) != 2 and len(self.Tab1input2.text()) != 3):
            if (len(self.Tab1name2) != 2 and len(self.Tab1name2) != 3):
                self.ballon12 = self.PopUpReady(self.Tab1input2, 'Invalid Value')
    ...
    def Tab2SaveCSV(self):
        ...
        if (self.Tab2NAME1col == []):
            self.ballonS2 = self.PopUpReady(self.Tab2table, 'No Data')
            return
    ...
    def Tab2ButtonClick(self):
        ...
        if (len(self.Tab2input1Text) != 2 and len(self.Tab2input1Text) != 3):
            if (len(self.Tab2input1.text()) != 2 and len(self.Tab2input1.text()) != 3):
                self.balloon21 = self.PopUpReady(self.Tab2input1, 'Invalid Value')

        if (self.Tab2input2.count() == 0):
            self.balloon22 = self.PopUpReady(self.Tab2input2, 'Invalid Value')
    ...
    def Tab3SaveCSV(self):
        if (self.Tab3NAME1col == [] or self.Tab3NAME2col == []):
            self.ballonS3 = self.PopUpReady(self.Tab3table, 'No Data')
            return
    ...
    def Tab3ButtonClick(self):
        ...
        if (self.Tab3input1.count() == 0):
            self.balloon31 = self.PopUpReady(self.GroupBox1, 'Invalid Value')

        if (self.Tab3input2.count() == 0):
            self.balloon32 = self.PopUpReady(self.GroupBox2, 'Invalid Value')
